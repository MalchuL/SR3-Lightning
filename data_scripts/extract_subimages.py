...
#         opt['save_folder'] = '/mnt/hyzhao/Documents/datasets/DIV2K_train800/DIV2K_train_LR_bicubic/X4_blur_sub'
        ...
        opt['save_folder'] = '/media/malchul/Новый том/Deep_Learning/datasets/superresolution/DIV2K_cropped/Bic_sub480'
...
#         save_LR_folder = '../../datasets/DIV2K/DIV2K800_sub_bicLRx4'
        ...
        GT_folder = '/media/malchul/Новый том/Deep_Learning/datasets/superresolution/DIV2K_cropped/HR/X4'
        LR_folder = '/media/malchul/Новый том/Deep_Learning/datasets/superresolution/DIV2K_cropped/LR/X4'
        save_GT_folder = '/media/malchul/Новый том/Deep_Learning/datasets/superresolution/DIV2K_cropped/DF2K_train/HRx4_sub360'
        save_LR_folder = '/media/malchul/Новый том/Deep_Learning/datasets/superresolution/DIV2K_cropped/DF2K_train/LRx4_sub120'
